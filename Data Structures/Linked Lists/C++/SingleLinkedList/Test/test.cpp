...
#define BOOST_TEST_MODULE SingleLinkedListTest
/*
* @author : Ionesio Junior
*/

#include <boost/test/unit_test.hpp>
#include "../IterativeLinkedList.hpp"
#include  "../RecursiveLinkedList.hpp"
#include <cstdlib>


struct setUp{
	LinkedList<int> *list1 = new IterativeSingleLinkedList<int>();
	LinkedList<int> *list2 = new RecursiveSingleLinkedList<int>();
};
